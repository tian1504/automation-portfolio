...
const WORKFLOW_IMAGES = [
  ...
  { src: workflowInstagram, thumbnail: workflowInstagram, alt: 'Instagram Scraper & Hook Idea Engine', category: 'data',
    description: 'Scrapes Instagram profiles and posts, analyzes engagement patterns, and generates hook ideas for content creation.',
    tools: ['n8n', 'Apify', 'OpenAI'] },
  { src: workflowRAG, thumbnail: workflowRAG, alt: 'RAG Knowledge Base Pipeline', category: 'data',
    description: 'Ingests documents into a vector database and enables retrieval-augmented generation for accurate, context-aware AI responses.',
  ...
  { src: workflowInternalGPT, thumbnail: workflowInternalGPT, alt: 'Internal ChatGPT Assistant', category: 'communication',
    description: 'A private ChatGPT-style assistant connected to internal company knowledge bases for instant employee support.',
    tools: ['n8n', 'OpenAI', 'Notion'] },
  { src: workflowMultiAgent, thumbnail: workflowMultiAgent, alt: 'Multi-Agent AI System', category: 'communication',
    description: 'Orchestrates multiple specialized AI agents that collaborate to solve complex tasks through structured reasoning.',
  ...
  { src: workflowHookBank, thumbnail: workflowHookBank, alt: 'Hook Bank & UGC Brief Builder', category: 'communication',
    description: 'Curates a library of viral hooks and auto-generates UGC creative briefs tailored to brand voice and audience.',
  ...
  { src: workflowStatic, thumbnail: workflowStatic, alt: 'Static Prompt & Image Engine (n8n)', category: 'automation',
    description: 'Generates social media images from templated prompts, applies brand styling, and queues them for scheduled posting.',
  ...
  { src: workflowVideoGen, thumbnail: workflowVideoGen, alt: 'AI Video Generator & Facebook Uploader', category: 'automation',
    description: 'Creates short-form videos from text prompts using AI, adds captions, and automatically uploads to Facebook pages.',
  ...
  { src: workflowWeather, thumbnail: workflowWeather, alt: 'Daily Weather Quote & Image Poster', category: 'automation',
    description: 'Fetches daily weather data, pairs it with an inspirational quote, generates a branded image, and posts it automatically.',
    tools: ['n8n', 'OpenAI'] },
  { src: workflowOrganic, thumbnail: workflowOrganic, alt: 'Multi-Channel Organic Content System', category: 'automation',
    description: 'Repurposes a single piece of content into platform-optimized posts for multiple social channels simultaneously.',
