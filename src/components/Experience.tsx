...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    periodShort: "2026 — NOW",
    title: "Book-Sourcing Engine — Used-Book Amazon FBA",
    company: "Freelance · Book arbitrage seller (Upwork)",
    bullets: [
      "Building a sourcing engine that scans ~2,000 used-book listings each morning across AbeBooks, Biblio, and Alibris and ends with a daily buy list that fits the client's budget.",
      ...
      "230 automated checks pin behaviour before any change ships; a deliberate gate keeps the scraping engine from being edited casually.",
